...
const footerLinks = {
  ...
  contact: {
    ...
    map: "https://maps.app.goo.gl/arGEC4RkTn7ZaWGbA",
  ...
  socials: [
    {
      name: "Instagram",
      href: "https://www.instagram.com/namma_briyani__?igsh=NHE2aWxsamtmZWp6",
      icon: (
    ...
    {
      name: "Facebook",
      href: "https://www.facebook.com/share/1A6UoDsaPP/",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
